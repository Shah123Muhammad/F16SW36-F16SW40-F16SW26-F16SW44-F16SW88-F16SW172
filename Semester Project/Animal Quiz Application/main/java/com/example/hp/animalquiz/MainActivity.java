...
public class MainActivity extends AppCompatActivity {
    ...
    static Typeface chunkfive;//Typeface is used to hold the fonts in our application
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //Preference Manager class is used in-order to manage Settings
        PreferenceManager.setDefaultValues(MainActivity.this, R.xml.quiz_preferences,false);
     //Changes made by the user in settings it gets notify us:
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Intent preferencesIntent=new Intent(MainActivity.this, SettingActivity.class);
